...
impl FOO {
    ...
    pub const fn const_deref(&self) -> &'static TypedSection<fn()> {
        static SECTION: TypedSection<fn()> = {
                ...
                ::link_section::__support::PtrBounds::new(
                    {
                        ...
                        extern "C" {
                            #[link_name = "\u{1}section$start$__DATA$FOO06Y_1qTvDbT"]
                            static __SYMBOL: u8;
                        }
                    ...
                    },
                    {
                        #[allow(missing_unsafe_on_extern)]
                        extern "C" {
                            #[link_name = "\u{1}section$end$__DATA$FOO06Y_1qTvDbT"]
                            static __SYMBOL: u8;
                        }
                        unsafe { &raw const __SYMBOL as *const () }
                    },
            ...
            let name = "__DATA,FOO06Y_1qTvDbT";
...
fn foo() {
    const _: fn() = const {
        ...
        #[used]
        #[link_section = "__DATA,FOO06Y_1qTvDbT,regular,no_dead_strip"]
